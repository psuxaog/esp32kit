...
extern void OLED_DrawAscString8x16(uint8_t x, uint8_t y, char *str, color_t color);
extern void OLED_DrawAscString7x14(uint8_t x, uint8_t y, char *str, color_t color);
extern void OLED_DrawAscString5x7(uint8_t x, uint8_t y, char *str, color_t color);
extern void OLED_DrawAscString5x7Len(uint8_t x, uint8_t y, char *str, color_t color,uint8_t len);
...
extern void OLED_DrawBMP(uint8_t x, uint8_t y,const uint8_t *bmp, color_t color);
